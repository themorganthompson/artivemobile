...
function attach(toolbox) {
    ...
    function install(opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var name, reactNativeVersion, reactNativeTemplate, perfStart, rnOptions, cmd, withTemplate, spinner, stdioMode, e_1, fullTemplateName, perfDuration, successMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        cmd = ramda_1.trim("npx react-native init " + name + " " + rnOptions.join(' '));
