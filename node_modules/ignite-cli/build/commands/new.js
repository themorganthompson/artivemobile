...
module.exports = {
    ...
    run: function command(toolbox) {
        return __awaiter(this, void 0, void 0, function () {
            var parameters, strings, print, filesystem, system, ignite, prompt, runtime, meta, isBlank, upperFirst, camelCase, log, projectName, projectNameCamel, overwrite, boilerplateName, boilerplates, boilerplate, originalFolder, appFolder, deepFolder, ok, deepFiles, yarnOrNPM, spinner, gitCommand;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        parameters = toolbox.parameters, strings = toolbox.strings, print = toolbox.print, filesystem = toolbox.filesystem, system = toolbox.system, ignite = toolbox.ignite, prompt = toolbox.prompt, runtime = toolbox.runtime, meta = toolbox.meta;
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, system.run(yarnOrNPM)];
                    case 9:
                        _a.sent();
                        spinner.succeed(yarnOrNPM + " complete");
                        if (!(!parameters.options['skip-git'] && !filesystem.exists('./.git') && system.which('git'))) return [3 /*break*/, 11];
                        spinner = print.spin('setting up source control with git');
                        gitCommand = "git init . && git add -A && git commit -m \"Initial commit\n\nIgnite CLI version " + meta.version() + "\"";
                        ignite.log('setting up git repo with command:');
                        ignite.log(gitCommand);
                        return [4 /*yield*/, system.run(gitCommand)];
                    case 10:
                        _a.sent();
