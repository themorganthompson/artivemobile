...
module.exports = {
    ...
    run: function (toolbox) {
        return __awaiter(this, void 0, void 0, function () {
            var separator, _a, run, which, _b, colors, info, table, padEnd, ignite, runtime, meta, column1, column2, column3, platform, arch, cpus, firstCpu, cpu, cores, directory, nodePath, nodeVersion, _c, _d, npmPath, npmVersion, _e, yarnPath, yarnVersion, _f, ignitePath, igniteSrcPath, igniteVersion, igniteJson, installedGenerators, igniteTable, androidPath, javaPath, javaVersionCmd, javaVersion, _g, _h, _j, _k, xcodePath, xcodeVersion, _l, _m, _o, cocoaPodsPath, cocoaPodsVersion, _p;
            return __generator(this, function (_q) {
                switch (_q.label) {
                    case 0:
                        separator = toolbox.filesystem.separator, _a = toolbox.system, run = _a.run, which = _a.which, _b = toolbox.print, colors = _b.colors, info = _b.info, table = _b.table, padEnd = toolbox.strings.padEnd, ignite = toolbox.ignite, runtime = toolbox.runtime, meta = toolbox.meta;
                    ...
                    case 1:
                        nodeVersion = _c.apply(void 0, _d.concat([_q.sent()]));
                        npmPath = which('npm');
                        _e = npmPath;
                    ...
                    case 5:
                        ...
                        igniteSrcPath = "" + meta.src;
                        return [4 /*yield*/, run('ignite version', { trim: true })];
                    case 6:
                        igniteVersion = _q.sent();
                        igniteJson = ignite.loadIgniteConfig();
                        installedGenerators = runtime.commands
                    ...
                    case 7:
                        _g = _h.apply(void 0, [_j.apply(void 0, _k.concat([_q.sent()]))]);
                        _q.label = 8;
                    case 8:
                        javaVersion = _g;
                        info('');
                    ...
                    case 9:
                        _l = _m.apply(void 0, _o.concat([_q.sent()]))[1]; // lulz
                        _q.label = 10;
                    case 10:
                        xcodeVersion = _l;
                        info('');
                        ...
                        if (!cocoaPodsPath) return [3 /*break*/, 12];
