...
module.exports = {
    ...
    run: function (toolbox) {
        return __awaiter(this, void 0, void 0, function () {
            var print, parameters, prompt, ignite, system, info, warning, xmark, error, success, options, moduleParam, isScoped, moduleName, config, changes, ok, generatorsList_1, updatedConfig, modulePath, pluginFile, pluginModule, e_1, removeCommand;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        print = toolbox.print, parameters = toolbox.parameters, prompt = toolbox.prompt, ignite = toolbox.ignite, system = toolbox.system;
                        ...
                        if (!existsLocally(moduleName)) return [3 /*break*/, 12];
                    ...
                    case 9:
                        ...
                        _a.label = 10;
                    case 10:
                        removeCommand = useYarn ? "yarn remove " + moduleName : "npm rm " + moduleName + " --save-dev";
                        print.warning('Removing dev module');
                        return [4 /*yield*/, system.exec(removeCommand, { silent: true })];
                    case 11:
                        _a.sent();
